...
- **Hypernetworks for pruning / learned pruning criteria** — brief nod to prior learned-mask approaches if any are worth distinguishing from (needs a lit check, not yet done — flagging as a TODO rather than guessing at citations).
